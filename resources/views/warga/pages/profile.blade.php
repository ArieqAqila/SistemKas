...
{{-- Modal --}}
    ...
    <div class="modal fade ff-asap" id="ubahNama" tabindex="-1" aria-labelledby="modalEditNama" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <form action="" method="POST">
            @csrf
    ...
    <div class="modal fade ff-asap" id="ubahTglLahir" tabindex="-1" aria-labelledby="modalEditTglLahir" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <form action="" method="POST">
            @csrf
    ...
    <div class="modal fade ff-asap" id="ubahNoTelp" tabindex="-1" aria-labelledby="modalEditNoTelp" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <form action="" method="POST">
            @csrf
                ...
                <div class="col-lg-7 m-3">
                    ...
                    <div class="">
                        <dl class="row gy-1 ms-1 mt-1 fs-7">
                            ...
                            <dd class="col-md-8 p-0">
                                {{ Auth::user()->nama_user }}
                                <button class="text-primary ms-2" data-bs-toggle="modal" data-bs-target="#ubahNama">Ubah</button>
                            </dd>                                                               
        
                            <dt class="col-md-3 fw-medium">Tanggal Lahir</dt>
                            <dd class="col-md-8 p-0">
                                @if (Auth::user()->tgl_lahir == null)
                                    <button class="text-primary ms-2" data-bs-toggle="modal" data-bs-target="#ubahTglLahir">Masukkan tanggal lahir anda.</button>
                                @else
                                    {{ DateHelper::formatDateIndonesia($date) }}
                                    <button class="text-primary ms-2" data-bs-toggle="modal" data-bs-target="#ubahTglLahir">Ubah Tgl Lahir</button>
                                @endif                                    
                            </dd>                                                    
                        </dl>
                    </div>
                    ...
                    <div class="">
                        <dl class="row gy-1 ms-1 mt-1 fs-7">                                                            
                            ...
                            <dd class="col-md-8 p-0">
                                {{ Auth::user()->notelp }}
                                <button class="text-primary ms-2" data-bs-toggle="modal" data-bs-target="#ubahNoTelp">Ubah</button>
                            </dd>
                            
                            
                            <dt class="col-8 col-md-7 fw-medium mt-3">
                                <a href="{{ route('reset-password') }}" class="btn btn-warning text-white fw-medium px-4" data-bs-toggle="modal" data-bs-target="#resetPassword">Reset Password</a>
                            </dt>
                        </dl>
                    </div>
                </div>                                       
